// Based on this article https://medium.com/@AlexanderObregon/building-restful-apis-with-c-4c8ac63fe8a7
// Install this first: sudo apt-get install nlohmann-json3-dev
// Run with: g++ api.cpp -o api $(pkg-config --cflags --libs opencv4 gtk+-3.0) -std=c++17 -Wall -Wextra -O2 && ./api
